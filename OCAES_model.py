...
# E_WIND = E_WIND.tolist()
# grid_price = grid_price.system_energy_price_rt.to_list()
...
model.N_WELLS = Var(within=NonNegativeIntegers, initialize=0, bounds = (1,1000))  # Number of wells (>0, integer)
model.X_OCAES = Var(within=NonNegativeReals, initialize=0.0, bounds=(1,600))  # The machinery rating (>0, MW)
